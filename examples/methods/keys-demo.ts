...
console.log("  Keys:", [...positiveRange.keys()]);
console.log();
...
console.log("  Keys:", [...positiveReverseRange.keys()]);
console.log();
...
console.log("  Keys:", [...positiveStepRange.keys()]);
console.log();
...
console.log("  Keys:", [...positiveReverseStepRange.keys()]);
console.log();

// 5. Negative range
console.log("5. Negative range (-5 to -1):");
const negativeRange = new PyRange(-5, -1); // [-5, -4, -3, -2]
console.log("  Keys:", [...negativeRange.keys()]);
console.log();
...
console.log("  Keys:", [...negativeReverseRange.keys()]);
console.log();
...
console.log("  Keys:", [...negativeStepRange.keys()]);
console.log();
...
console.log("  Keys:", [...negativeReverseStepRange.keys()]);
console.log();
...
console.log("  Keys:", [...negToPositiveRange.keys()]);
console.log();
...
console.log("  Keys:", [...posToNegativeRange.keys()]);
console.log();
...
console.log("  Keys:", [...negToPositiveStepRange.keys()]);
console.log();
...
console.log("  Keys:", [...posToNegativeStepRange.keys()]);
console.log();
...
const emptyKeys = [...emptyRange.keys()];
if (emptyKeys.length === 0) {
  console.log("  Keys: [] (no keys - empty range)");
} else {
  console.log("  Keys:", emptyKeys);
}
console.log();
